...
PICS = (environ.get('PICS', 'https://envs.sh/lRQ.jpg https://envs.sh/lRh.jpg https://i.ibb.co/ch3n9wsf/x.jpg')).split() 
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7892735262').split()]  #Admin Id
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002635146044').split()] #Movie Database Channel Id
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002437184347'))  #Log Channel Id
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002437184347')) #Premium Subscription Log Channel Id
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vipsrmwebseries:vipsrmwebseries@cluster0.znggu43.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #MongoDB Url
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002663892706 -1002625147245')) 
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002663892706 -1002625147245'))

IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002437184347')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002437184347')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
